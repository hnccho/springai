...
public class AiController {
	...
	// ##### 요청 매핑 메소드 #####
	@PostMapping(value = "/txt-pdf-docx-etl",
	...
	@PostMapping(value = "/compression-query-transformer",
				 consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
				 produces = MediaType.TEXT_PLAIN_VALUE)
	...
	@PostMapping(value = "/rewrite-query-transformer",
				 consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
				 produces = MediaType.TEXT_PLAIN_VALUE)
	...
	@PostMapping(value = "/translation-query-transformer",
				 consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
				 produces = MediaType.TEXT_PLAIN_VALUE)
	...
	@PostMapping(value = "/multi-query-expander",
				 consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
				 produces = MediaType.TEXT_PLAIN_VALUE)
